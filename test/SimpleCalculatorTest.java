...
public class SimpleCalculatorTest {
    ...
    public void testSub0and0() throws OpenDataException {
        int first = 0;
        int second = 0;
        int expected = 0;
    ...
    public void testSub1and0() throws OpenDataException {
        int first = 1;
        int second = 0;
        int expected = 1;
    ...
    public void testSub0and1() throws OpenDataException {
        int first = 0;
        int second = 1;
        int expected = -1;
    ...
    @Test
    @DisplayName("Testing sub 0 - 0")
    public void testSub5and3() throws OpenDataException {
        int first = 5;
        int second = 3;
        int expected = 2;
